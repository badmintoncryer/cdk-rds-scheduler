...
| <code><a href="#cdk-rds-scheduler.RdsScheduler.with">with</a></code> | Applies one or more mixins to this construct. |
...
##### `with` <a name="with" id="cdk-rds-scheduler.RdsScheduler.with"></a>
...
###### `mixins`<sup>Required</sup> <a name="mixins" id="cdk-rds-scheduler.RdsScheduler.with.parameter.mixins"></a>
